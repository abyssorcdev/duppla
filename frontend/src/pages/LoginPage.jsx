    ...
    <div className="min-h-screen flex items-center justify-center bg-brand-50 px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-800">Duppla</h1>
          <p className="text-gray-500 text-sm mt-1">Gestión de Documentos Financieros</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          ...
          <p className="text-sm text-gray-500 mb-6">
            Accede con tu cuenta de Google. Si es tu primer ingreso, quedarás en espera de aprobación.
          </p>
